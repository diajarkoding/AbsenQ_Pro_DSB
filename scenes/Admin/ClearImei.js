...
import {clearImei} from '../../redux/actions/adminAction';
...
class ClearImei extends Component {
  constructor(props) {
    super(props);
  ...
  _nextButton = async () => {
    ...
    flag
      ? this.props.clearImei(this.state).then(success => {
          if (success) {
            shandling('SUCCESS clear imei');
...
const mapDispatchToProps = {clearImei};
